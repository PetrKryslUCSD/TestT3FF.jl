...
let
    ...
    for distortion in [2.0, 0.0]
        ns, results100 = cos_2t_press_hyperboloid_free_examples.test_convergence(FEMMShellT3FFModule, 1/100, distortion)
        ns, results1000 = cos_2t_press_hyperboloid_free_examples.test_convergence(FEMMShellT3FFModule, 1/1000, distortion)
